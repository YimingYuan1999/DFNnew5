...
parser.add_argument("--data_path",type=str, default="../data/RainTrainH/",help='path to training data')
...
def main():
    ...
    model = RRFBN(iterations=opt.recurrent_iter,blocks=opt.number_blocks)
